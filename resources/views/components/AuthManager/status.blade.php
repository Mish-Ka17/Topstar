<div class="w-[100%]">
    @isset($user)
      <el-dropdown class="inline-block">
        <button class="inline-flex w-full justify-center gap-x-1.5 px-2 py-2 rounded-md bg-white/10 text-sm font-semibold text-gray-800 hover:bg-white/20 cursor-pointer"
        title="{{$user->name}}">
        {{$user->name}}
